...
#ifdef iGPU
        mutable real          EPS;                     // eps
    public: 
      mutable real EQ;                                 // eps^2 
    protected: 
#else
...
#pragma omp atomic update seq_cst
    ...
    public:
        ...
        // OpenCL Kernels 
        //--------------------------------------------------------------------------
        void cellCellCpfalcON(unsigned const&A0, unsigned NA,
			      unsigned const&B0, unsigned NB) const;
        void cellSelfCpfalcON(unsigned  const&A0, unsigned N1) const;
        void cellLeafCpfalcON(unsigned const&A, unsigned const&B, unsigned N1) const;
#endif

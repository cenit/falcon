...
#define DISPLAY(level_required, inst) if (INFO_DISPLAY_LEVEL >= level_required){ inst; }
#endif 
////////////////////////////////////////////////////////////////////////////////
...
namespace falcON {
    ...
    public:
        ...
        public:
            ...
            //------------------------------------------------------------------------
            void set_acpn(acpn_data*acp)
            {
                
                PROP = static_cast<void*>(acp);
            }
...
#undef __srce
    ...
    private:
      ...
      void map_PotAcc();
      void map_MPoles();
      void map_Local_Coefs();
      void unmap_PotAcc();
      void unmap_MPoles();
      void unmap_Local_Coefs();
#endif
        //--------------------------------------------------------------------------
